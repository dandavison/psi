...
*** \subsubsection{No-admixture model: updating the hyperparameters of $q(\pi)$}
...
*** \subsubsection{Admixture model: updating the hyperparameters of $q(\pi)$}
...
*** \subsubsection{No-admixture model: Updating the hyperparameters of $q(\mu)$}
...
*** \subsubsection{Admixture model: Updating the hyperparameters of $q(\mu)$}
