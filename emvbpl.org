...
* Overview of Paper
  ...
  :END:
In section \ref{sec:models} I describe the models and introduce notation. The
models studied are the "No Admixture Model" and the "Admixture Model"
of \cite{Pritchard_et_al_2000}, and the "F Model" of
\cite{Falush_et_al_2003}. In section \ref{sec:model-fitting} I describe new
...
provided in the \ref{sec:appendix}. Section \ref{sec:results} presents results of using
the different methods to fit the models to simulated and real
data. Finally in section \ref{sec:discussion} I discuss potential applications
...
#+begin_src emacs-lisp :exports results
  (setq org-latex-to-pdf-process '("pdflatex %s" "bibtex %b" "pdflatex %s"))
